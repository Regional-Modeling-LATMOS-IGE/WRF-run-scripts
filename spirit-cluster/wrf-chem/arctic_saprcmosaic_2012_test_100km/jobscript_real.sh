#!/bin/bash
#-------- Set up and run real for a WRF-Chem SAPRC-MOSAIC-8bin-AQ (simplified SOA) run --------
#
# Louis Marelle, 2023/01/18
#
...
sed -i "s:WRFRUNDIR:$PWD/:g" mozbc_saprcmosaic8bin.inp
mozbc < mozbc_saprcmosaic8bin.inp > mozbc.out
...
#sed -i "s:WRFRUNDIR:$PWD/:g" cambc_saprcmosaic8bin.inp
#mozbc < cambc_saprcmosaic8bin.inp > mozbc.out
