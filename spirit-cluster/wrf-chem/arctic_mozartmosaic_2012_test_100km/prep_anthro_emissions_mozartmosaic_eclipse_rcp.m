function [] = prep_anthro_emissions_mozartmosaic_eclipse_rcp(startdate, enddate)

  %-------- Create WRF-Chem emissions (wrfchemi_d0*) for the MOZARTMOSAIC mechanism --------------%
  %
  ...
  SPECNAMES_MOZARTMOSAIC = {'CO', 'NH3', 'SO2', 'NO', 'NO2', 'BIGALK', 'BIGENE', 'C2H4',...
                            'C2H5OH', 'C2H6', 'C3H6', 'C3H8', 'CH2O', 'CH3CHO', 'CH3COCH3', 'CH3OH',...
                            'MEK', 'TOLUENE', 'ORGJ', 'ECJ'};
  % Emission datasets species
  SPECNAMES_ECLIPSE = {'CO', 'NH3', 'SO2', 'NOx', 'NOx', 'VOC', 'VOC', 'VOC',...
                       'VOC', 'VOC', 'VOC', 'VOC', 'VOC', 'VOC', 'VOC', 'VOC',...
                       'VOC', 'VOC', 'OC', 'BC'};
  ECLIPSE_SECTORS = {'ene', 'ind', 'dom', 'tra', 'agr', 'wst', 'slv'};
  SPECNAMES_RCP = {'CO', 'NH3', 'SO2', 'NO', 'NO', 'NMVOC', 'NMVOC', 'NMVOC',...
                   'NMVOC', 'NMVOC', 'NMVOC', 'NMVOC', 'NMVOC', 'NMVOC', 'NMVOC', 'NMVOC',...
                   'NMVOC', 'NMVOC', 'OC', 'BC'};

  % Molarweights for mechanism species, NOx = NO2 in inventory
  MOLARWEIGHTS_ECLIPSE = [28, 17, 64, 46, 46, NaN, NaN, NaN,...
                          NaN, NaN, NaN, NaN, NaN, NaN, NaN, NaN,...
                          NaN, NaN, NaN, NaN];
  MOLARWEIGHTS_RCP = [28, 17, 64, 30, 30, NaN, NaN, NaN,...
                      NaN, NaN, NaN, NaN, NaN, NaN, NaN, NaN,...
                      NaN, NaN, NaN, NaN];
  ...
  nspecies = length(SPECNAMES_MOZARTMOSAIC);
    ...
    for imonth = 1:length(months_list_m) 
      ...
      for iday = 1:length(days_in_month)
        ...
        for ihour = 0:0
          ...
          create_netcdffile_mozartmosaic_dms(wrfchemi_filename, SPECNAMES_MOZARTMOSAIC,...
          ...
          % to wrfchemi
          for ispecies = 1:nspecies
            specname_mechanism = SPECNAMES_MOZARTMOSAIC{ispecies};
            ...
            if(specname_RCP)
              ...
              elseif(strcmp(specname_RCP, 'OC'))
                % kg/m2/s OC to ug/m2/s POM
                data_wrf_RCP = data_wrf_RCP * 1E9 * oc_pom_factor;
